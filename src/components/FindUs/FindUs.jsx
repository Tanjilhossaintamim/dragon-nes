  ...
  return (
    <div className={`${user ? "mt-0" : "mt-8"}`}>
      ...
      <ul className="mt-6 h-48 border border-color-dark-6 rounded">
        ...
        <li className="h-1/3 border-y border-color-dark-6 flex items-center text-color-dark-3 text-[16px] font-medium">
          <a href="www.google.com" className="flex items-center w-full">
            <svg
              className="mx-2"
              xmlns="http://www.w3.org/2000/svg"
              width="30"
